...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ isset($preselected_role) && $preselected_role === 'owner' ? 'Daftar Sebagai Pemilik Lapangan' : __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Hidden role field -->
                        @if(isset($preselected_role) && $preselected_role === 'owner')
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ isset($preselected_role) && $preselected_role === 'owner' ? 'Daftar Sebagai Pemilik Lapangan' : __('Register') }}
                                </button>
                            </div>
                        </div>
                    </form>
